...
function M.load(colors, config)
  ...
  local highlights = {
    ...
    IncSearch = { fg = colors.bg, bg = colors.caramel },
    Substitute = { fg = colors.bg, bg = colors.caramel },
    ...
    Title = { fg = colors.caramel, bold = true },
    ...
    SpecialComment = { fg = colors.caramel, italic = italic_comments },
    Debug = { fg = colors.red },
    Underlined = { fg = colors.blue, underline = underline_links },
    Ignore = { fg = colors.brown_light },
    Error = { fg = colors.error },
    Todo = { fg = colors.caramel, bold = true },
    ...
    ["@comment"] = { fg = colors.fg_darker, italic = italic_comments },
    ["@comment.documentation"] = { fg = colors.caramel, italic = italic_comments },
    ["@comment.error"] = { fg = colors.error },
    ["@comment.warning"] = { fg = colors.warning },
    ["@comment.todo"] = { fg = colors.caramel, bold = true },
    ["@comment.note"] = { fg = colors.info },
    ["@markup.strong"] = { bold = true },
    ["@markup.italic"] = { italic = true },
    ["@markup.strikethrough"] = { strikethrough = true },
    ["@markup.underline"] = { underline = true },
    ["@markup.heading"] = { fg = colors.caramel, bold = true },
    ...
    TelescopePromptTitle = { fg = colors.caramel, bold = true },
    TelescopePreviewTitle = { fg = colors.caramel, bold = true },
    TelescopeResultsTitle = { fg = colors.caramel, bold = true },
    TelescopeSelection = { fg = colors.fg, bg = colors.pmenu_sel },
    TelescopeSelectionCaret = { fg = colors.caramel },
    TelescopeMatching = { fg = colors.caramel, bold = true },
    ...
    NvimTreeRootFolder = { fg = colors.caramel, bold = true },
    ...
    NeoTreeRootName = { fg = colors.caramel, bold = true },
    NeoTreeFileName = { fg = colors.fg },
    NeoTreeFileIcon = { fg = colors.fg },
    NeoTreeFileNameOpened = { fg = colors.caramel },
    ...
    BufferLineIndicatorSelected = { fg = colors.caramel, bg = colors.bg },
    ...
    -- Lualine
    lualine_a_normal = { fg = colors.bg, bg = colors.caramel, bold = true },
